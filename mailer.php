...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $to = "bishlranjansutar6292gmail.com";  // Change to your recipient email

    // Email subject.
    $subject = "Personalized Message from $name";

    // Email headers.
    $headers = "From: bishalranjansutar629@gmail.com\r\n"; // Update with your sender email
    $headers .= "Reply-To: bishalranjansutar629@gmail.com\r\n";
